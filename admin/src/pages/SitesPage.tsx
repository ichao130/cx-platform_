...
import { collection, doc, onSnapshot, query, setDoc, deleteDoc, where, orderBy } from 'firebase/firestore';
...
export default function SitesPage() {
  ...
  async function createOrUpdate() {
    ...
    await setDoc(doc(db, 'sites', safeId), payload, { merge: true });
    resetEditor();
                ...
                <Fragment key={r.id}>
                  <tr>
                    ...
                    <td>
                      ...
                      <button className="btn btn--danger" onClick={() => deleteDoc(doc(db, 'sites', r.id))}>
                        削除
                      </button>
                    </td>
                  </tr>
