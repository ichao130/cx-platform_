 ...
 * ========================= */
// MediaPickerModal は components/MediaPickerModal.tsx に切り出して QuestionsPage 等と共有
...
export default function ActionsPage() {
  ...
  useEffect(() => {
    ...
    //   未確定のまま「先頭サイト」を選ぶと、直後のPersist効果がそれを保存して
    //   ユーザーが選んだサイト（保存値）を破壊してしまうため（非同期の到着順で発生）。
